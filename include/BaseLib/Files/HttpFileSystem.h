...
#ifndef BaseLib_Files_HttpFileSystem_h
#define BaseLib_Files_HttpFileSystem_h
...
class BL_EXPORT HttpFileSystem : public AbstractFileSystem {
public:

	BL_DECLARE_REFLECTION_BASELIB_CLASS(BaseLib::Files::HttpFileSystem, AbstractFileSystem);

	HttpFileSystem(const String& forURI);
...
#endif // #ifndef BaseLib_Files_HttpFileSystem_h
