...
#ifndef BaseLib_Files_ZipFileSystem_h
#define BaseLib_Files_ZipFileSystem_h
...
class BL_EXPORT ZipFileSystem : public AbstractFileSystem {
public:

	BL_DECLARE_REFLECTION_BASELIB_CLASS(BaseLib::Files::ZipFileSystem, AbstractFileSystem);

	ZipFileSystem(const String& forURI);
	...
	virtual void enumFileNames(const Enumerator<String>& enumerator, const String& path = ".", bool enumHiddenDirectories = false, bool enumSystemDirectories = false) const;
	...
	virtual void enumDirectoryNames(const Enumerator<String>& enumerator, const String& path = ".", bool enumHiddenFiles = false, bool enumSystemFiles = false) const;
...
#endif // #ifndef BaseLib_Files_ZipFileSystem_h
