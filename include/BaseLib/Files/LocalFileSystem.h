...
#ifndef BaseLib_Files_LocalFileSystem_h
#define BaseLib_Files_LocalFileSystem_h
...
class BL_EXPORT LocalFileSystem : public AbstractFileSystem {
public:

	BL_DECLARE_REFLECTION_BASELIB_CLASS(BaseLib::Files::LocalFileSystem, AbstractFileSystem);

	LocalFileSystem(const String& forURI);
...
private:
	...
	mutable Array<String> lastPathContent;
	Array<String>::Enumeration lastPathContentEnumeration;
...
#endif // #ifndef BaseLib_Files_LocalFileSystem_h
