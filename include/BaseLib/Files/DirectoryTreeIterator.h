...
#ifndef BaseLib_Files_DirectoryTreeIterator_h
#define BaseLib_Files_DirectoryTreeIterator_h
...
/**
*/
class BL_EXPORT DirectoryTreeIterator : public BaseLib::Trees::AbstractTreeIterator {
public:

	static const String FILE_TYPE;
	static const String DIRECTORY_TYPE;

	BL_DECLARE_REFLECTION_BASELIB_CLASS(BaseLib::Files::DirectoryTreeIterator, BaseLib::Trees::AbstractTreeIterator);

	DirectoryTreeIterator(AbstractFileSystem* forFileSystem, bool enumHiddenDirectories = false, bool enumSystemDirectories = false, const NumberFormat* useNumberFormat = NumberFormat::getDefault());
	DirectoryTreeIterator(const AbstractFileSystem* forConstFileSystem, bool enumHiddenDirectories = false, bool enumSystemDirectories = false, const NumberFormat* useNumberFormat = NumberFormat::getDefault());
...
private:
	...
	bool enumHiddenDirectories;
	bool enumSystemDirectories;
...
#endif // #ifndef BaseLib_Files_DirectoryTreeIterator_h
