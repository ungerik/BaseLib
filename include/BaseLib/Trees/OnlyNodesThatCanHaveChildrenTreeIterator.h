...
#ifndef BaseLib_Trees_OnlyNodesThatCanHaveChildrenTreeIterator_h
#define BaseLib_Trees_OnlyNodesThatCanHaveChildrenTreeIterator_h
...
*/
class BL_EXPORT OnlyNodesThatCanHaveChildrenTreeIterator : public AbstractTreeIterator {
public:

	BL_DECLARE_REFLECTION_BASELIB_CLASS(BaseLib::Trees::OnlyNodesThatCanHaveChildrenTreeIterator, AbstractTreeIterator);

	OnlyNodesThatCanHaveChildrenTreeIterator(const TreeIterator& newSource);
...
#endif // #ifndef BaseLib_Trees_OnlyNodesThatCanHaveChildrenTreeIterator_h
