...
#ifndef BaseLib_Reflection_AbstractSetDoublePropertyFunctor_h
#define BaseLib_Reflection_AbstractSetDoublePropertyFunctor_h
...
struct BL_EXPORT AbstractSetDoublePropertyFunctor : public AbstractSetPropertyFunctor {

	DoubleProperty* property;

	AbstractSetDoublePropertyFunctor(DoubleProperty* forProperty);
...
#endif // #ifndef BaseLib_Reflection_AbstractSetDoublePropertyFunctor_h
