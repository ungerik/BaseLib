...
#ifndef BaseLib_Streams_DoubleInputStream_h
#define BaseLib_Streams_DoubleInputStream_h
...
/**
Converts every read call to a read(double) call.
Beside an InputStream the stream can be connected to a functor alternatively.
Read-calls of every type get converted into read(double) calls.
@see @ref BuffersAndStreams, DoubleOutputStream, InputStream, connectToFunctor()
*/
class BL_EXPORT DoubleInputStream : public InputStream {
public:
	...
	DoubleInputStream();
	explicit DoubleInputStream(const InputStream& connectToInputStream);
	explicit DoubleInputStream(const Functor& connectToGetterFunctor);
	explicit DoubleInputStream(const double* value);
	explicit DoubleInputStream(double value);
...
#endif // #ifndef BaseLib_Streams_DoubleInputStream_h
