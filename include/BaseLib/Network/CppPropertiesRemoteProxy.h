...
#ifndef CppPropertiesRemoteProxy_h
#define CppPropertiesRemoteProxy_h
...
class AMAZONAS CppPropertiesRemoteProxy : public AbstractCppProperties {
public:

	CppPropertiesRemoteProxy(CppPropertiesRemoteConnection& remoteConnection);
...
protected:
	...
	CppPropertiesRemoteConnection& connection;
};

*/

#endif // #ifndef CppPropertiesRemoteProxy_h