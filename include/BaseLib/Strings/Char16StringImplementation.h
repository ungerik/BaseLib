...
#ifndef BaseLib_Strings_Char16StringImplementation_h
#define BaseLib_Strings_Char16StringImplementation_h
...
class BL_EXPORT Char16StringImplementation : public AbstractStringImplementation {
public:

	Char16StringImplementation(int length = 0/*, std::locale& newLocale = factory.getLocale()*/);
	virtual ~Char16StringImplementation();
...
#ifdef BL_DEFAULT_STRING_IMPLEMENTATION_IS_UNICODE
	typedef Char16StringImplementation DefaultStringImplementation;
#endif
...
#endif // #ifndef BaseLib_Strings_Char16StringImplementation_h